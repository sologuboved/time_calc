...
# print(calculate_time_series("23.55.55 + 6.6 + 1"))  # 1 day, 0:02:02
# print(calculate_time_series("27.0 * 2"))  # 0:54:00
# print(calculate_time_series("1.56.17 - 8.0 - 1.0.0 + 0 + 20.7 - 1.0"))  # 1:07:24
# print(calculate_time_series("49.0.7 - 3.10.7 - 72.59.0 * 2 + 2 + 54.17.58"))  # 0:00:00
